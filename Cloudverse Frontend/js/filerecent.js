function ListFiles() {
  try {
    document.getElementById("user1238").innerHTML =
...
function listrecentfiles() {
  try {
    document.getElementById("user1238").innerHTML =
      "Hi " + sessionStorage.getItem("Name") + "!";
    var create = document.getElementById("createrecentfiles");
    var date = new Date();
    create.innerHTML = "";
    fetch(
      "http://localhost:58604/api/folder/Recent/" +
